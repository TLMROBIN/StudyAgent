...
class Settings(BaseSettings):
    ...
    mineru_lang: str = Field(default="ch", alias="MINERU_LANG")
    mineru_device: str = Field(default="cuda", alias="MINERU_DEVICE")
    mineru_device_mode: str = Field(default="cuda", alias="MINERU_DEVICE_MODE")
    mineru_model_source: str = Field(default="local", alias="MINERU_MODEL_SOURCE")
    mineru_require_gpu_proof: bool = Field(default=True, alias="MINERU_REQUIRE_GPU_PROOF")
